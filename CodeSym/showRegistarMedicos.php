...
<div class="w3-card-4 w3-container w3-display-topmiddle w3-theme-l5" style="width:70%; height:100%; overflow:scroll;">
	...
	<form name ="registo" method="POST" action="index.php?op=cRegistarMedicos" onsubmit="return ValidaterRegisto()" class="w3-container"  enctype="multipart/form-data" >
			<br>
    		...
    		<div class="w3-row-padding">
 		    ...
 		    <br>
 		    <label class="w3-text-theme"><strong>T&iacute;tulo: </strong></label> 
 		    	<input class="w3-radio" type="radio" name="newTit" value="0" checked > <label>Dr. </label>
				<input class="w3-radio" type="radio" name="newTit" value="1"> <label>Dr&ordf;.</label>
 		    <br><br>
