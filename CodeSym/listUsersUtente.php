<?php
	...
	$sql_medicos = 'SELECT * FROM UTILIZADORES WHERE (TIPO = 1) ORDER BY NOME';
    			...
    			<?php
    			 while($rows = mysqli_fetch_array($result_medicos)):?>
                	...
                	<tr class="w3-theme-l5"> 
                			<td>
                				<button class ="w3-theme-d3" style='font-size:24px'><?php echo "<a href='index.php?op=vUtente&id=".$rows['ID']."'>";?> <i class="far fa-file" style="font-size:24px"></i><?php echo "</a>";?></button>
                				<button class ="w3-theme-d3" style='font-size:24px'><?php echo "<a href='index.php?op=aUtente&id=".$rows['ID']."'>";?> <i class="far fa-edit" style="font-size:24px"></i><?php echo "</a>";?></button>
                			</td>
