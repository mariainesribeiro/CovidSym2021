<?php
    			...
    			$result_distritos = mysqli_query ($connect, $sql_distritos) or die ('1The query failed: ' .mysqli_error($connect));
    			

    			
    			$select_med = 'SELECT * FROM UTILIZADORES WHERE ID='.$_SESSION['ID'];
...
<SCRIPT type="text/javascript">
    ...
    //ValidaÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o do Username
