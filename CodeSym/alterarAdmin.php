...
<div class="w3-card-4 w3-container w3-display-topmiddle w3-theme-l5" style="width:70%; height:100%; overflow:scroll;">
	...
	<div class="w3-container">
		<h3 style="color:#003E63"><strong>Alterar Registo do Administrador</strong></h3>
		<br>				
...
function myHide(id) {
  ...
  if (x.className.indexOf("w3-show") == -1) {
    ...
    x.className = x.className.replace(" w3-show", "");
			...
			<label class="w3-text-theme"><strong>Username: </strong></label><input class=" w3-input w3-border-0"  onblur="checkNewUsername(this.value)" type="text" name="newUser" value="<?php echo $admin['USERNAME'];?>" required>
    		...
    		<br>
				...
				<div class="w3-row-padding">
 		    			<div class="w3-half">
 		    					<input type=hidden id ="old_pass" name="old_pass" value="<?php echo $admin['PASSWORD']; ?>">
